...
function normalizeDate(csvDate: string): string {
  ...
  const months: Record<string, string> = {
    "7": "Jul", "1": "Jan", "2": "Feb", "3": "Mar", "4": "Apr",
    "5": "May", "6": "Jun", "8": "Aug", "9": "Sep", "10": "Oct",
    "11": "Nov", "12": "Dec",
  };
...
function normalizeSessionType(csvType: string): string {
  ...
  if (
    lower.includes("preliminary") || lower.includes("pool") ||
    lower.includes("group") || lower.includes("qualification") ||
    lower.includes("ranking") || lower.includes("repechage")
  ) return "Prelim";
